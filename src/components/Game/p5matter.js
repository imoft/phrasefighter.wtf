...
var p5matter = (function () {
   ...
   * <code>setup</code> function of your window.p5.js sketch. It is not a big deal if
  ...
  var init = function () {
    ...
    if (engine === null) {
      ...
      engine = Matter.Engine.create(null,options);
  ...
  var makeBarrierBall = function (x, y, width, height, options) {
    var barrier = new BarrierBall(x, y, width, options);
    barrier.freeze();
    addToWorld(barrier);
    return barrier;
  };
  ...
  PhysicalObject.prototype.isOffCanvas = function (bufferZone) {
    ...
    var maxX = window.p5.width + wid + bufferZone;
    var maxY = window.p5.height + hgt + bufferZone;
  ...
  Ball.prototype.show = function () {
    window.p5.push();
    window.p5.translate(this.getPositionX(), this.getPositionY());
    window.p5.rotate(this.getAngle());
    window.p5.ellipseMode(window.p5.CENTER);
    window.p5.ellipse(0, 0, this.getWidth(), this.getHeight());
    window.p5.pop();
  };
  ...
  var BarrierBall = function (x, y, diameter, options) {
    var body = Matter.Bodies.circle(x, y, diameter / 2, options);
    PhysicalObject.call(this, body, diameter, diameter);
  };
  BarrierBall.prototype = Object.create(PhysicalObject.prototype);
  BarrierBall.prototype.constructor = BarrierBall;

  

  BarrierBall.prototype.show = function () {
    window.p5.push();
    window.p5.stroke(0)
    window.p5.strokeWeight(4);
    window.p5.translate(this.getPositionX(), this.getPositionY());
    window.p5.rotate(this.getAngle());
    window.p5.ellipseMode(window.p5.CENTER);
    window.p5.ellipse(0, 0, this.getWidth(), this.getHeight());
    ...
    window.p5.ellipse(-this.getHeight()*0.2, -6, 10,10);
    window.p5.ellipse(this.getHeight()*0.2, -6, 10,10);
    window.p5.rectMode(window.p5.CENTER);

    window.p5.rect(0,17,this.getWidth()*0.5, 5 );

    window.p5.pop();
  };

  /**
   * Get the diameter of the BarrierBall. Alias for
   * <code>PhysicalObject#getWidth</code>.
   *
   * @returns {number}
   * @function
   */
  BarrierBall.prototype.getDiameter = BarrierBall.prototype.getWidth;

  /**
   * Get the radius of the BarrierBall.
   *
   * @returns {number}
   */
  BarrierBall.prototype.getRadius = function () {
    return this.getDiameter() / 2;
  };
  ...
  Block.prototype.show = function () {
    ...
    window.p5.rotate(this.getAngle());
    window.p5.rectMode(window.p5.CENTER);
    window.p5.rect(0, 0, this.getWidth(), this.getHeight());
    window.p5.pop();
  };
  ...
  var Sign = function (text, x, y, options) {
    this.text = text;
    Block.call(this, x, y, window.p5.textWidth(text), window.p5.textSize(), options);
  };
  ...
  Sign.prototype.show = function () {
    window.p5.push();
    window.p5.translate(this.getPositionX(),
      this.getPositionY() + this.getHeight() * 0.25);
    window.p5.rotate(this.getAngle());
    window.p5.textAlign(window.p5.CENTER);
    window.p5.text(this.getText(), 0, 0);
    window.p5.pop();
  };
  ...
  return {
    ...
    makeBarrierBall: makeBarrierBall,
